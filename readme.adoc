...
TODO: Link to the existing instructions.
...
The CloudFormation template used for this is at https://github.com/aws-samples/ecs-refarch-cloudformation/blob/master/master.yaml.
