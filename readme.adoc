...
. Pull dependent packages: `pack dep -f .` This will generate `manifests/vendor` folder.
...
+
This is currently blocked by https://github.com/aws-samples/aws-microservices-deploy-options/issues/180.
+
