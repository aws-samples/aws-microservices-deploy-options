...
You can also setup the Cluster using CloudFormation from Console. If you prefer that:
...
3. Once the stack completes, inspect the contents of this file `ecs-cluster.prop`. Then source this property file
...
8. Generate the ecs-params.yml for name service
...
11. Generate the ecs-params.yml for webapp service
