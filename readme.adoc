...
.. BY default, the image name is `arungupta/greeting`. Create the image in your repo as: `mvn -pl greeting package -Pdocker -Ddocker.repo=<repo>`
...
.. BY default, the image name is `arungupta/name`. Create the image in your repo as: `mvn -pl name package -Pdocker -Ddocker.repo=<repo>`
...
.. BY default, the image name is `arungupta/webapp`. Create the image in your repo as: `mvn -pl webapp package -Pdocker -Ddocker.repo=<repo>`
