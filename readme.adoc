...
. Create `webapp` service:
  ...
  fargate service create webapp-service \
    ...
    -i arungupta/webapp \
    -p http:8080 \
    -e GREETING_SERVICE_HOST=options-lb-436743184.us-east-1.elb.amazonaws.com \
    -e GREETING_SERVICE_PORT=80 \
    -e GREETING_SERVICE_PATH=/resources/greeting \
    -e NAME_SERVICE_HOST=options-lb-436743184.us-east-1.elb.amazonaws.com \
    -e NAME_SERVICE_PORT=80 \
    -e NAME_SERVICE_PATH=/resources/names/1
