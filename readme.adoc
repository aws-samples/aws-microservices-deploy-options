...
.. Create pipeline for Greeting service
...
.. Create pipeline for Name service
...
.. Create pipeline for WebApp service
...
. Change to the repo which needs to be included in the pipeline. Add CodeCommit repo:
