...
a| image::./images/deploy-to-aws.png[link=https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=Codesuite-Demo&templateURL=https://s3.amazonaws.com/compute-options-public/master.yaml]
|===

Check the output of the infrastructure stack in cloudformation console and look for the Public ALB CNAME, you can use that hostname to access the application.
