package org.aws.samples.compute.webapp.serverless;
...
public class StreamLambdaHandler implements RequestStreamHandler {
    private static final ResourceConfig jerseyApplication = new ResourceConfig().packages("org.aws.samples.compute.webapp");
